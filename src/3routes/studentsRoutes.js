...
//Método: GET | URL: http://localhost:3000/api/students
...
//Método: GET | URL: http://localhost:3000/api/students/id
...
//Método: POST | URL: http://localhost:3000/api/students/name
//Exemplo do BODY:
//{
//    "name": "mar"
//}
...
//Método: GET | URL: http://localhost:3000/api/students/hour/:id
...
//Método: GET | URL: http://localhost:3000/api/students/necessity/:id
...
//Método: POST | URL: http://localhost:3000/api/students
...
//Método: POST | URL: http://localhost:3000/api/students/:id
...
//Método: PUT | URL: http://localhost:3000/api/students/:id
